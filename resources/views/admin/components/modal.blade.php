<div class="modal fade" id="Delete_cate_Modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<div class="modal fade" id="Delete_se_cate_Modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ url('admin/delete-se_cate_id') }}" method="POST">
                @csrf
                @method('DELETE')
                <div class="modal-body text-center">
