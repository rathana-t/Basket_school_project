    ...
    <div class="text-center">
        <div class="navbar-menu user-navbar">
            <div class="container pl-0 pr-0 pt-3 pb-2 border-bottom ">
                <nav class="nav">
                    <a class="nav-link {{ Request::is('profile') ? 'ac' : '' }}"
                        href="{{ route('display-profile') }}">
                    ...
                    <a class="nav-link {{ Request::is('message*') ? 'ac' : '' }}" href="/message">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                    ...
                    <a class="nav-link {{ Request::is('history-order') ? 'ac' : '' }}"
                    ...
                    <a class="nav-link {{ Request::is('order') ? 'ac' : '' }}" href="{{ url('/order') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                    ...
                    {{-- <a class="nav-link {{ Request::is('profile') ? 'ac' : '' }}" href="">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                    ...
                    <a class="nav-link {{ Request::is('wishlist') ? 'ac' : '' }}" href="{{ route('list-wish') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                    ...
                    <a class="nav-link {{ Request::is('changepassword') ? 'ac' : '' }}"
                    ...
                    <a class="nav-link {{ Request::is('switchAccount') ? 'ac' : '' }}"
                        href="{{ route('switch-acc') }}">
                        <div class="change">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
